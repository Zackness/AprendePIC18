...
The **name** is your variable; an **SFR** has a fixed factory name. That difference is covered in [Architecture — GPR vs SFR](/en/fundamentos/arquitectura/#gpr--general-purpose-registers).
