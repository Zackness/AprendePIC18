...
<Figure
	...
	alt="Topic 2 minimum system diagram for PIC18F4550: crystal, C1/C2, MCLR with 10 kΩ and pushbutton, VDD and VSS"
	caption="Minimum system per Topic 2 class slide: crystal between OSC1/OSC2 with C1 and C2 to ground, 10 kΩ pull-up on MCLR, reset button, and +5 V on VDD/VSS."
	credit="Class Topic 2 and 3 — PIC Architecture (UNEXPO · Prof. Ing. Yoel Pire)"
/>
