...
This page is **Topic 4 in depth**: how to use **TRIS, PORT, and LAT together** in real code and UNEXPO labs. It builds on the [ports guide](/en/tutoriales/guias/puertos/) and [First LED](/en/tutoriales/primer-led/) — they come **before** this page in the sidebar and [study path](/en/ruta-de-estudio/).
