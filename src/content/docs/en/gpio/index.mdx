...
You already saw the three registers in [Registers — GPIO](/en/fundamentos/registros/#gpio-ports--trisx-portx-latx), applied them in the [ports guide](/en/tutoriales/guias/puertos/) and [First LED](/en/tutoriales/primer-led/), and built with [MPLAB and Proteus](/en/fundamentos/mplab-proteus/). This page is **Topic 4 in depth**: not just definitions — how to use **TRIS, PORT, and LAT together** in real code and UNEXPO labs.
...
More exercises in [Set direction with TRIS](/en/tutoriales/guias/puertos/1-tris-direccion/).
...
Practical guide: [Write outputs with LAT](/en/tutoriales/guias/puertos/2-lat-salidas/) and [First LED tutorial](/en/tutoriales/primer-led/).
...
Practical guide: [Read inputs with PORT](/en/tutoriales/guias/puertos/3-port-entradas/).
