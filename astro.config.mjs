...
export default defineConfig({
	...
	redirects: {
		...
		'/fundamentos/retardos': '/retardos/',
		'/en/fundamentos/retardos': '/en/retardos/',
		'/fundamentos/comparaciones-registros': '/comparaciones/',
		'/en/fundamentos/comparaciones-registros': '/en/comparaciones/',
